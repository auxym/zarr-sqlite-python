"""
**zarr-sqlite** is a Python library which provides `SQLiteStore`, a
single-file store implementation backed by SQLite for
[zarr-python](https://zarr.readthedocs.io/en/stable/). It combines Zarr's
chunked, hierarchical data model with SQLite's single-file database format,
mutability and ACID guarantees.
